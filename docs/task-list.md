...
- [x] Add Ren'Py script with starting variables.
- [x] Add opening shop scene.
- [x] Add inventory review.
- [x] Add first customer interaction.
...
- [ ] Add persistent mystery flags.
- [ ] Add simple shop ledger UI.
